...
Unit tests for the code in the "stretch_xx" file, testing stretch
and load functions by assessing whether the resulting stretch/load
matches the applied ones.
...
def test_stretch_xx_fixed_sides(dim):
    ...
    evaluated_stretch = evaluate_stretch(cm.u, mesh, ds)
