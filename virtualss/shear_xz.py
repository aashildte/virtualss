...
def shear_xz_fixed_sides(V, boundary_markers):
    """
    ...
    if top_dim == 2:
        ...
        return _shear_xz_fixed_sides_3D(V, boundary_markers, mesh)
    else:
        raise NotImplementedError()


def _shear_xz_fixed_sides_3D(V, boundary_markers, mesh):
